...
RUN apt-get update && \
    ...
    freeglut3-dev libsm-dev libgtk2.0-dev pkg-config \
...
COPY ./customtkinter_example.py /opt/retroarch/
...
CMD ["sh", "-c", "dbus-launch --exit-with-session startxfce4 & cd /opt/dolphin && mkdir -p /home/ralt/Downloads/RetroArch-Linux-x86_64/RetroArch-Linux-x86_64.AppImage.home/system/dolphin-emu && cp -r Data/Sys /home/ralt/Downloads/RetroArch-Linux-x86_64/RetroArch-Linux-x86_64.AppImage.home/system/dolphin-emu && . /opt/venv/bin/activate && python3 /opt/retroarch/customtkinter_example.py"]
