...
COPY ./supervisordglcore.conf /etc/supervisor/conf.d/supervisordglcore.conf
...
CMD ["sh", "-c", "dbus-launch --exit-with-session startxfce4 & cd /opt/dolphin && mkdir -p /home/ralt/Downloads/RetroArch-Linux-x86_64/RetroArch-Linux-x86_64.AppImage.home/system/dolphin-emu && cp -r Data/Sys /home/ralt/Downloads/RetroArch-Linux-x86_64/RetroArch-Linux-x86_64.AppImage.home/system/dolphin-emu && supervisord -c /etc/supervisor/conf.d/supervisordglcore.conf && . /opt/venv/bin/activate && python3 /opt/retroarch/RetroGLCore.py"]
