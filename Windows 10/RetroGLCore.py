...
def run_killall():
    ...
    try:
        subprocess.run(["pkill", "-f", "/home/ralt/Downloads/RetroArch-Linux-x86_64/RetroArch-Linux-x86_64.AppImage"], check=True)
...
def finalize_process(shaders, crashed_shaders):
    ...
    with open(crash_report_path, 'w') as file:
        file.write(f"Video_driver = glcore\n")
